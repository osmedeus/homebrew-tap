...
class Osmedeus < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "832e8e322cd4be30feb7cf7c55919f60442646f68b488e2c9eecd62a842e734c"
    end
    on_intel do
      url "https://github.com/j3ssie/osmedeus/releases/download/v#{version}/osmedeus_#{version}_darwin_amd64.tar.gz"
      sha256 "b5c38effce692b2772fc22781b26ca8dee661098531b3ed12f47ff3ac200ee3c"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "2dc78225031cb90c6a8c298ccf241cc6efaaf3df9a5d9e1c14a745749fe739ae"
    end
    on_intel do
      url "https://github.com/j3ssie/osmedeus/releases/download/v#{version}/osmedeus_#{version}_linux_amd64.tar.gz"
      sha256 "041473975d9e9c47f90f31df9e48e6a67c0457acfd4adee9a17786b0c6475039"
    end
  end
